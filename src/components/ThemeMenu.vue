  ...
  <details ref="menu" class="relative" @keydown.esc="close">
    ...
    <div class="absolute right-0 top-full z-50 mt-2 w-44 rounded-2xl border border-slate-200 bg-white p-1.5 shadow-lg dark:border-slate-700 dark:bg-slate-800" role="menu" aria-label="Appearance">
      <button
        ...
        :class="preference === option.value ? 'bg-blue-50 text-blue-700 dark:bg-blue-500/15 dark:text-blue-200' : 'text-slate-700 dark:text-slate-200'"
